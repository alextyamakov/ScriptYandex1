...
public class MarketPage extends BasePageObject {
    ...
    @FindBy(xpath = "//*[@id='153061']/div")
    WebElement checkboxSamsung;

    @FindBy(xpath = "//*[@id='153074']/div")
    ...
    public void selectCheckBoxSamsung () {
        ((JavascriptExecutor) BaseSteps.driver).executeScript("arguments[0].scrollIntoView(true);", checkboxSamsung);
        checkboxSamsung.click();
    }

    public void selectCheckBoxLg () {
        ((JavascriptExecutor) BaseSteps.driver).executeScript("arguments[0].scrollIntoView(true);", checkboxLg);
        checkboxLg.click();
    }
